  ...
  $('#payment_ticket_btn').click(function (e) {
    ...
    for (var index = 0; index < formsPassenger.length; index++) {
      ...
      for (var y = 0; y < element.length; y++) {
        var Yelement = element[y]; // console.log($(Yelement)[0]["name"]);
    ...
    for (var _index = 0; _index < formDataArray.length; _index++) {
      var element = formDataArray[_index]; // console.log(element);

      var _iterator = _createForOfIteratorHelper(element.entries()),
          _step;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          console.log("\u041A\u043B\u044E\u0447 = ".concat(pair[0], ", \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435 = ").concat(pair[1]));
        }
      } catch (err) {
        _iterator.e(err);
      } finally {

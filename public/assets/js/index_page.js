...
$(document).ready(function () {
    ...
    if (name_user != "" && text_review != "") {
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          if (data.status) {
            var new_review_item = document.createElement('div');
            ...
            var new_review_item_name_user = document.createElement('div');
            ...
            var new_review_item_date = document.createElement('div');
            ...
            var new_review_item_text_review = document.createElement('div');
  ...
  $('#more_review_btn').click(function (e) {
    ...
    if ($(this).text() == "Показать еще") {
      ...
      $('body,html').animate({
        scrollTop: $('.reviews_block').offset().top - 50
      }, 100);
    }
  });
});

$(document).ready(function () {
    ...
    $(document).on('click', '.flght_table_block__item__edit_btn',function (e) {
        ...
        let start__city = $(row).find('.flght_table_block__item__info__flight_plan__start__city').text().split(' ')[0];
        let end__city = $(row).find('.flght_table_block__item__info__flight_plan__end__city').text().split(' ')[0];
        let start__date = $.trim($(row).find('.flght_table_block__item__info__flight_plan__start__iata_code_date').text()).split(' ')[0];
        let end__date = $.trim($(row).find('.flght_table_block__item__info__flight_plan__end__iata_code_date').text()).split(' ')[0];
        let start__time = $.trim($(row).find('.flght_table_block__item__info__flight_plan__start__iata_code_date').text().split(' ')[1]);
        let end__time = $.trim($(row).find('.flght_table_block__item__info__flight_plan__end__iata_code_date').text().split(' ')[1]);

        let day_start = start__date.split('-')[0];
        let month_start = start__date.split('-')[1];
        let year_start = start__date.split('-')[2];

        let day_end = end__date.split('-')[0];
        let month_end = end__date.split('-')[1];
        let year_end =end__date.split('-')[2];

        flight_code = $.trim($(row).find('.flght_table_block__item__info').find('.flght_table_block__item__info__flight_number').text());
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status) {
                        ...
                        let start__city = $(row).find('.flght_table_block__item__info__flight_plan__start__city');
                        let end__city = $(row).find('.flght_table_block__item__info__flight_plan__end__city');
                        let start__date = $(row).find('.flght_table_block__item__info__flight_plan__start__iata_code_date');
                        let end__date = $(row).find('.flght_table_block__item__info__flight_plan__end__iata_code_date');
                        let start__time = $(row).find('.flght_table_block__item__info__flight_plan__start__iata_code_date');
                        let end__time = $(row).find('.flght_table_block__item__info__flight_plan__end__iata_code_date');
                        let travel__time = $(row).find('.flght_table_block__item__info__flight_plan__travel_time');
                        ...
                        end__date.text(data.date_end + ' ' + data.time_end);
                        // start__time.text(data.time_start);

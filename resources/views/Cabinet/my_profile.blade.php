            ...
            <div class="profile_data_cards">
                ...
                <div class="my_travel_block profile_data_cards_non_view">
                    ...
                    <div class="my_travel_block__cards">
                                        ...
                                        <div class="short_details_order df_jcspb_aic">
                                                ...
                                                <div class="short_flight_scheme__block">
                                                    <div class="short_flight_scheme__city_from">
                                                        ...
                                                        <div class="details_city df_jcspb_aic">
                                                            ...
                                                            <!-- /.time_flight -->
                                                            <div class="date_flight">{{ \Jenssegers\Date\Date::parse($auth_user__flight_arr['flight_from']["date_start"])->format('Y/m/d') }}</div>
                                                            <!-- /.date_flight -->
                                                        </div>
                                                        <!-- /.details_city -->
                                                    </div>
                                                    ...
                                                    <div class="short_flight_scheme__city_to">
                                                        ...
                                                        <div class="details_city df_jcspb_aic">
                                                            ...
                                                            <!-- /.aiport_name -->
                                                            <div class="time_flight">{{ \Jenssegers\Date\Date::parse($auth_user__flight_arr['flight_from']["time_end"])->format('H:i') }}</div>
                                                            <!-- /.time_flight -->
                                                            <div class="date_flight">{{ \Jenssegers\Date\Date::parse($auth_user__flight_arr['flight_from']["date_end"])->format('Y/m/d') }}</div>
                                                            <!-- /.date_flight -->
                                                        </div>
                                                        <!-- /.details_city -->
                                                    </div>
                                            ...
                                            <div class="status_order df_jcspb_aic">
                                                <div class="status_order__name">
                                                    <span class="non_view__text_mobile">Статус рейса: </span> {{ $auth_user__flight_arr['booking_status_from']->name_status }}
                                                </div>
                                                <!-- /.status_order__name -->
                                            ...
                                            <!-- /.cancel_order -->
                                            <!-- /.status_order -->
                                            <div class="price_order"><span class="non_view__text_mobile">Цена: </span> {{ htmlspecialchars($auth_user__flight_arr['flight_from']["cost"]) }} <i class="fas fa-ruble-sign" aria-hidden="true"></i></div>
                                            <!-- /.price_order -->
                                        </div>
                                    </div>
                        ...
                        @else
                            <div class="my_travel_block__cards__item">
                                <p>У вас в этом году нет еще ни одной поездки</p>
                            </div>
                            <!-- /.my_travel_block__cards__item -->
                        @endif

...
@section('content')
    <div class="container df_jcc_aic content_flex">
        <form action="" class="form form_auth" id="form_forgot_password">
            <h1>Забыли пароль?</h1>
            <div class="form_auth_block">
                <label for="email_forgot">Email</label>
                <input type="text" autocomplete="off" class="form_auth_input md_input" id="email_forgot" name="email_forgot" placeholder="Введите свою почту">
            </div>
            <!-- /.form_auth_block -->
            <div class="form_auth_block">
            ...
            <div class="form_auth_block df_jcspb_aic">
                <a href="{{ route('login__page') }}" class="link_auth">Авторизоваться</a>

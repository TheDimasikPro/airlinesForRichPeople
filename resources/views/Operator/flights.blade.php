...
@if ($operator["status"] == "future")
    @section('title')
        Редактирование будущих рейсов
    @endsection
@endif
@if ($operator["status"] == "operating")
    @section('title')
        Редактирование действующих рейсов
    @endsection
@endif
@if ($operator["status"] == "invalid")
    @section('title')
        Редактирование прошедших рейсов
    @endsection
@endif
@section('content')
    ...
    <div class="flight_info_block">
        <div class="flight_info_block_form_sort">
            <form action="" method="get">
                ...
                @endif
                @if ($operator["status"] == "operating")
                    <h2>Форма поиска действующих рейсов</h2>
                @endif
                @if ($operator["status"] == "invalid")
                    <h2>Форма поиска прошедших рейсов</h2>
                @endif

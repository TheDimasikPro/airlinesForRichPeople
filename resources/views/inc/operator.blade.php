            ...
            <nav class="navbar">
                <ul class="navbar__list">
                    <li class="navbar__list__item">
                        <button class="navbar__list__item__btn navbar__list__item__btn_active" id="btn_open_close_aside">
                            <i class="fas fa-bars"></i>
                            <i class="fas fa-arrow-right non_view"></i>
                        </button>
                    </li>
                    <!-- /.navbar__list__item -->
                    <li class="navbar__list__item">
                        <a href="{{ route('my_profile__page') }}" class="navbar__list__item__link non_view">Профиль</a>
                    ...
                    <!-- /.navbar__list__item -->
                    <li class="navbar__list__item">
                        <a href="" class="navbar__list__item__link non_view">Будущие рейсы</a>
                        <!-- /.navbar__list__item__link -->
                    ...
                    <!-- /.navbar__list__item -->
                    <li class="navbar__list__item">
                        <a href="" class="navbar__list__item__link non_view">Действующие рейсы</a>
                        <!-- /.navbar__list__item__link -->
                    ...
                    <!-- /.navbar__list__item -->
                    <li class="navbar__list__item">
                        <a href="" class="navbar__list__item__link non_view">Прошедшие рейсы</a>
                        <!-- /.navbar__list__item__link -->

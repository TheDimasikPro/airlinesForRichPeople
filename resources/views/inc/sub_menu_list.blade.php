<ul class="add_sub_menu_list">
    <a href="{{ route('baggage_info__page__carriage_of_animals') }}" class="sub_menu__link"><li class="sub_menu__item">Провоз животных на борту</li></a>
    ...
    <a href="{{ route('baggage_info__page') }}" class="sub_menu__link"><li class="sub_menu__item">Всё о багаже</li></a>
</ul>
<ul class="add_sub_menu_list">
